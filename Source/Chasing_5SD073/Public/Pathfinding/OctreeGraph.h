...
public:
	...
	static bool LazyOctreeAStar(const bool& ThreadIsPaused, const bool& Debug, const TArray<FBox>& ActorBoxes, const float& MinSize, const float FloatAboveGroundPreference, const FVector& StartLocation, const FVector& EndLocation, const TSharedPtr<OctreeNode>& RootNode, TArray<FVector>& OutPathList);
	...
	static float AvgPathLength;
	static int NudgeCounter;
