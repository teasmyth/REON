...
{
	if (PlayerCharacter->GetWallMechanicHitResult()->GetActor() == HitResult.GetActor() && !PlayerCharacter->GetWhetherTouchedGroundOrWall())
	{
	...
	PlayerCharacter->SetWhetherTouchedGroundOrWall(true);
